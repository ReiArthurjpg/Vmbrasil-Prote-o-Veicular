                    ...
                    <article style="gap: 1rem;" class="container-md d-flex justify-content-center align-items-center p-3">
                        ...
                        <div style="width: 22rem !important;" id="Cards06" class="card bg-black text-center d-flex justify-content-center w-50">
                            ...
                            <div class="card-body">
                                ...
                                <span class="text-light">
                                    <p>Tornar-se um referencial em</p>
                                    <p>assessoria e gestão no mercado de</p>
                                    <p>e-commerce, com foco nos</p>
                                    <p>marketplaces, oferecendo as</p>
                                    <p>melhores soluções em estratégias</p>
                                    <p>em vendas, gerando visibilidade e</p>
                                    <p>escalabilidade do negócio, levando</p>
                                    <p>uma empresa para outro nível,</p>
                                    <p>garantindo rentabilidade e</p>
                                    <p>eficiência.</p>
                                    <br><br>
                                </span>
                            </div>
                        ...
                        <div style="width: 22rem !important;" id="Cards06" class="card bg-black text-center d-flex justify-content-center w-50">
                            ...
                            <div class="card-body">
                                ...
                                <span class="text-light">
                                    <p>Os valores que norteiam nossas</p>
                                    <p>ações baseiam-se na ética, na</p>
                                    <p>transparência, no respeito mútuo,</p>
                                    <p>com responsabilidade e honestidade</p>
                                    <p>em todas as áreas em que atuamos,</p>
                                    <p>visando oferecer os melhores</p>
                                    <p>resultados, comprometidos em</p>
                                    <p>realizar as ações necessárias com</p>
                                    <p>agilidade e com um atendimento</p>
                                    <p>personalizado e humanizado.</p>
                                    <br><br>
                                </span>
                            </div>
                        </div>
